...
export function useInnerBlocksProps(props = {}, options = {}) {
  ...
  return {
    ...props,
    ref,
    children: createElement(InnerBlocks, {
      ...options,
      clientId: clientId,
      wrapperRef: ref
    })
...
function ControlledInnerBlocks(props) {
  useBlockSync(props);
  return createElement(UncontrolledInnerBlocks, {
    ...props
  });
}
...
const InnerBlocks = props => {
  ...
  return props.value && props.onChange ? createElement(ControlledInnerBlocks, {
    ...allProps
  }) : createElement(UncontrolledInnerBlocks, {
    ...allProps
  });
};

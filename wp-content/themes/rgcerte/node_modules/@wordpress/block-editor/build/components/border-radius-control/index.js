...
function BorderRadiusControl({
  ...
  return (0, _react.createElement)("fieldset", {
    ...
    as: "legend"
  }, (0, _i18n.__)('Radius')), (0, _react.createElement)("div", {
    className: "components-border-radius-control__wrapper"
  }, isLinked ? (0, _react.createElement)(_react.Fragment, null, (0, _react.createElement)(_allInputControl.default, {
  ...
  })) : (0, _react.createElement)(_inputControls.default, {
    min: MIN_BORDER_RADIUS_VALUE,
    onChange: onChange,
    selectedUnits: selectedUnits,
    setSelectedUnits: setSelectedUnits,
    ...
    units: units
  }), (0, _react.createElement)(_linkedButton.default, {

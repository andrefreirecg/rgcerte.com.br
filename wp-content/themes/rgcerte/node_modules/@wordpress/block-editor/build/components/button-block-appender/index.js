...
function ButtonBlockAppender({
  ...
  return (0, _react.createElement)(_inserter.default, {
    ...
    renderToggle: ({
      ...
      let inserterButton = (0, _react.createElement)(_components.Button, {
        ref: ref,
        onFocus: onFocus,
        tabIndex: tabIndex,
        ...
        disabled: disabled,
        label: label
      }, !hasSingleBlockType && (0, _react.createElement)(_components.VisuallyHidden, {
        as: "span"
      }, label), (0, _react.createElement)(_icons.Icon, {
        icon: _icons.plus
      }));
      if (isToggleButton || hasSingleBlockType) {
        inserterButton = (0, _react.createElement)(_components.Tooltip, {
          text: label
        }, inserterButton);
      }

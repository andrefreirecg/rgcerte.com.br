...
const InsertFromURLPopover = ({
  ...
  onClose,
  popoverAnchor
}) => (0, _react.createElement)(_urlPopover.default, {
...
const URLSelectionUI = ({
  ...
  return (0, _react.createElement)("div", {
    ...
    variant: "tertiary"
  }, (0, _i18n.__)('Insert from URL')), isURLInputVisible && (0, _react.createElement)(InsertFromURLPopover, {
    src: src,
...
function MediaPlaceholder({
  ...
  const renderDropZone = () => {
    ...
    return (0, _react.createElement)(_components.DropZone, {
      onFilesDrop: onFilesUpload,
      onHTMLDrop: onHTMLDrop
    });
  };
  const renderCancelLink = () => {
    return onCancel && (0, _react.createElement)(_components.Button, {
  ...
  const renderUrlSelectionUI = () => {
    return onSelectURL && (0, _react.createElement)(URLSelectionUI, {
  ...
  const renderFeaturedImageToggle = () => {
    return onToggleFeaturedImage && (0, _react.createElement)("div", {
      className: "block-editor-media-placeholder__url-input-container"
    }, (0, _react.createElement)(_components.Button, {
      className: "block-editor-media-placeholder__button",
  ...
  const renderMediaUploadChecked = () => {
    ...
    const uploadMediaLibraryButton = (0, _react.createElement)(_mediaUpload.default, {
    ...
    if (mediaUpload && isAppender) {
      return (0, _react.createElement)(_react.Fragment, null, renderDropZone(), (0, _react.createElement)(_components.FormFileUpload, {
        onChange: onUpload,
        accept: accept,
        multiple: !!multiple,
        render: ({
          ...
          const content = (0, _react.createElement)(_react.Fragment, null, (0, _react.createElement)(_components.Button, {
            variant: "primary",
    ...
    if (mediaUpload) {
      const content = (0, _react.createElement)(_react.Fragment, null, renderDropZone(), (0, _react.createElement)(_components.FormFileUpload, {
        variant: "primary",
        className: (0, _classnames.default)('block-editor-media-placeholder__button', 'block-editor-media-placeholder__upload-button'),
        onChange: onUpload,
        accept: accept,
  ...
  if (disableMediaButtons) {
    return (0, _react.createElement)(_check.default, null, renderDropZone());
  }
  return (0, _react.createElement)(_check.default, {

...
const ListViewBlockContents = (0, _element.forwardRef)(({
  ...
  return (0, _react.createElement)(_react.Fragment, null, AdditionalBlockContent && (0, _react.createElement)(AdditionalBlockContent, {
    block: block,
    ...
    onDragStart,
    onDragEnd
  }) => (0, _react.createElement)(_blockSelectButton.default, {
    ref: ref,
    className: className,
    block: block,
    onClick: onClick,

...
class URLInput extends _element.Component {
  ...
  render() {
    return (0, _react.createElement)(_react.Fragment, null, this.renderControl(), this.renderSuggestions());
  }
  renderControl() {
    const {
    ...
    return (0, _react.createElement)(_components.BaseControl, {
      ...
      ...inputProps
    }), loading && (0, _react.createElement)(_components.Spinner, null));
  }
  renderSuggestions() {
    const {
      className,
    ...
    }, suggestions.map((suggestion, index) => (0, _react.createElement)(_components.Button, {

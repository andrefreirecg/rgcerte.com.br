...
function LinkControlSearchResults({
  ...
  const searchResultsLabel = (0, _react.createElement)(_components.VisuallyHidden, {
    id: searchResultsLabelId
  }, labelText);
  return (0, _react.createElement)("div", {
    className: "block-editor-link-control__search-results-wrapper"
  }, searchResultsLabel, (0, _react.createElement)("div", {
    ...suggestionsListProps,
    className: resultsListClasses,
    "aria-labelledby": searchResultsLabelId
  }, (0, _react.createElement)(_components.MenuGroup, null, suggestions.map((suggestion, index) => {
    if (shouldShowCreateSuggestion && _constants.CREATE_TYPE === suggestion.type) {
      return (0, _react.createElement)(_searchCreateButton.default, {
    ...
    return (0, _react.createElement)(_searchItem.default, {

...
function BlockBreadcrumb({
  ...
  return (0, _react.createElement)("ul", {
  ...
  }, hasSelection && (0, _react.createElement)(_components.Button, {
    className: "block-editor-block-breadcrumb__button",
    variant: "tertiary",
    onClick: clearSelectedBlock
  }, rootLabel), !hasSelection && rootLabel, !!clientId && (0, _react.createElement)(_icons.Icon, {
    icon: _icons.chevronRightSmall,
    className: "block-editor-block-breadcrumb__separator"
  })), parents.map(parentClientId => (0, _react.createElement)("li", {
    key: parentClientId
    ...
    icon: _icons.chevronRightSmall,
    className: "block-editor-block-breadcrumb__separator"
  }))), !!clientId && (0, _react.createElement)("li", {

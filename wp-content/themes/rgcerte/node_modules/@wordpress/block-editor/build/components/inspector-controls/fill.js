...
function InspectorControlsFill({
  ...
  return (0, _react.createElement)(_components.__experimentalStyleProvider, {
    document: document
  }, (0, _react.createElement)(Fill, null, fillProps => {
    return (0, _react.createElement)(ToolsPanelInspectorControl, {
      fillProps: fillProps,
      children: children,
...
function ToolsPanelInspectorControl({
  ...
  const innerMarkup = (0, _react.createElement)(RegisterResetAll, {
    resetAllFilter: resetAllFilter
  }, children);
  return forwardedContext.reduce((inner, [Provider, props]) => (0, _react.createElement)(Provider, {
    ...props
  }, inner), innerMarkup);
}

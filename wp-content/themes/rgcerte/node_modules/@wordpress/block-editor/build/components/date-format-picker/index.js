...
function DateFormatPicker({
  ...
  return (0, _react.createElement)("fieldset", {
    ...
    as: "legend"
  }, (0, _i18n.__)('Date format')), (0, _react.createElement)(_components.ToggleControl, {
  ...
  }), format && (0, _react.createElement)(NonDefaultControls, {
    format: format,
    onChange: onChange
  }));
}
function NonDefaultControls({
  ...
  }), isCustom && (0, _react.createElement)(_components.TextControl, {
    __nextHasNoMarginBottom: true,

...
const withBlockControls = (0, _compose.createHigherOrderComponent)(BlockEdit => props => {
  ...
  return (0, _react.createElement)(_react.Fragment, null, showStopEditingAsBlocks && (0, _react.createElement)(_react.Fragment, null, (0, _react.createElement)(StopEditingAsBlocksOnOutsideSelect, {
    clientId: props.clientId,
    stopEditingAsBlock: stopEditingAsBlock
  }), (0, _react.createElement)(_components2.BlockControls, {
    group: "other"
  ...
  }, (0, _i18n.__)('Modify'))), (0, _react.createElement)(BlockEdit, {
    key: "edit",
    ...props
  }));
}, 'withToolbarControls');

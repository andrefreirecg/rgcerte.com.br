...
var Selector = Ye.input(function (_ref) {
  ...
  return "\n    display: none;\n\n    &:checked ~ .active {\n      margin-left: ".concat(position, "%;\n    }\n  ");
});

var selectorGenerator = function selectorGenerator(images) {
  var position = 20;
  return images.map(function (image, index) {
    position -= 20;
    return /*#__PURE__*/r__default['default'].createElement(Selector, {
      key: index,
      id: 'selector-' + index,
      name: "radio-btn",
      type: "radio",
...
var Slide = Ye.div(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  width: 20%;\n  transition: all 2s;\n  img {\n    width: 800px;\n    height: 500px;\n  }\n"])));

var slideGenerator = function slideGenerator(images) {
  return images.map(function (image, index) {
    return /*#__PURE__*/r__default['default'].createElement(Slide, {
      key: index,
      className: index === 0 ? 'active' : ''
    }, /*#__PURE__*/r__default['default'].createElement("img", {
      src: image,
      alt: ""
    }));
  });
...
var Text = Ye.p(function (_ref2) {
  var textColor = _ref2.textColor,
      backgroundColor = _ref2.backgroundColor;
  return "\n  position: absolute;\n  bottom: 60px;\n  display: flex;\n  justify-content: center;\n  width: 500px;\n  height: 70px;\n  margin: 0 20px;\n  padding: 10px;\n  color: ".concat(textColor, ";\n  border-left: 10px solid ").concat(backgroundColor, ";\n  background-color: ").concat(backgroundColor, ";\n  opacity: .7;\n  border-radius: 0 5px 5px 0;\n  line-height: 1.4;\n");
});
var Navigation = Ye.div(function (_ref3) {
  var color = _ref3.color,
      vertical = _ref3.vertical;
  return "\n  position: absolute;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  flex-direction: ".concat(vertical ? 'column' : 'row', ";\n  margin-top: ").concat(vertical ? '0' : '-40px', ";\n  margin-bottom: ").concat(vertical ? '40px' : '0', ";\n  top: ").concat(vertical ? '50%' : 'auto', ";\n  transform: ").concat(vertical ? 'translateY(-50%)' : 'none', ";\n  right: ").concat(vertical ? '-380px' : 'auto', ";\n  width: 100%;\n\n  label {\n    border: 3px solid ").concat(color, ";\n    padding: 6px;\n    border-radius: 10px;\n    cursor: pointer;\n    transition: 0.4s;\n    margin-right: 30px;\n    margin-bottom: ").concat(vertical ? '30px' : '0', ";\n    &:hover {\n      background-color: ").concat(color, ";\n    }\n  }\n");
});
...
var Slider = function (_a) {
    ...
    return (r__default['default'].createElement(r__default['default'].Fragment, null,
        r__default['default'].createElement(Container, { className: 'slider-container' },
            r__default['default'].createElement(SliderContent, { ref: sliderContentRef },
                r__default['default'].createElement(Slides, null,
                    ...
                    showText && images.length > 0 ? (r__default['default'].createElement(Text, { textColor: textColor, backgroundColor: backgroundColor }, paragraph)) : null),
                r__default['default'].createElement(Navigation, { color: color, vertical: vertical }, images.map(function (_, index) { return (r__default['default'].createElement("label", { key: index, htmlFor: 'selector-' + index })); })),
                r__default['default'].createElement(Navigation, null, images.map(function (_, index) { return (r__default['default'].createElement("div", { key: index })); }))))));
};

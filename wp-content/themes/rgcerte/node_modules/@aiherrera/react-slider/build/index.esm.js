import r$2, { useRef, useDebugValue, useContext, createElement, createRef, useEffect } from 'react';
...
var selectorGenerator = function selectorGenerator(images) {
  ...
  return images.map(function (image, index) {
    position -= 20;
    return /*#__PURE__*/r$2.createElement(Selector, {
      key: index,
      id: 'selector-' + index,
      name: "radio-btn",
      type: "radio",
...
var slideGenerator = function slideGenerator(images) {
  return images.map(function (image, index) {
    return /*#__PURE__*/r$2.createElement(Slide, {
      key: index,
      className: index === 0 ? 'active' : ''
    }, /*#__PURE__*/r$2.createElement("img", {
      src: image,
      alt: ""
    }));
  });
...
var Slider = function (_a) {
    ...
    var sliderContentRef = createRef();
    var interval;
    var counter = 0;
    ...
    return (r$2.createElement(r$2.Fragment, null,
        r$2.createElement(Container, { className: 'slider-container' },
            r$2.createElement(SliderContent, { ref: sliderContentRef },
                r$2.createElement(Slides, null,
                    selectorGenerator(images),
                    slideGenerator(images),
                    showText && images.length > 0 ? (r$2.createElement(Text, { textColor: textColor, backgroundColor: backgroundColor }, paragraph)) : null),
                r$2.createElement(Navigation, { color: color, vertical: vertical }, images.map(function (_, index) { return (r$2.createElement("label", { key: index, htmlFor: 'selector-' + index })); })),
                r$2.createElement(Navigation, null, images.map(function (_, index) { return (r$2.createElement("div", { key: index })); }))))));
};
